...
RUN_VIVADO_BACKEND=0
RUN_CATAPULT_BACKEND=1
...
#model.load_weights('keras/ds8l0_noscaling_qkeras_foldbatchnorm_d58w4a8model.h5')

model = tf.keras.models.load_model('keras/ds8l0_noscaling_qkeras_foldbatchnorm_d58w4a8model.h5', custom_objects=co)
