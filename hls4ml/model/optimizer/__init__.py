...
try:
    ...
    register_flow('optimize', ['eliminate_linear_activation', 'fuse_consecutive_batch_normalization', 'fuse_batch_normalization', 'replace_multidimensional_dense_with_conv', 'set_precision_concat', 'propagate_dense_precision', 'propagate_conv_precision'], requires=['convert'])
except:
